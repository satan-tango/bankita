...
public class TransactionService {
    ...
    public TransactionResponseDTO executeTransaction(Transaction transaction) throws ExchangeRateApiException, AccountNotFoundException {
        ...
        return TransactionResponseDTO.builder()
                ...
                .datetime(transaction.getTransactionTimestamp())
                .limitSum(accountLimit.getAmount())
                .limitDatetime(accountLimit.getLimitTimestamp())
                .limitCurrencyShortName(accountLimit.getLimitCurrency())
                .build();
    }
}
